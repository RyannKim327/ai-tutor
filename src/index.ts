...
async function main() {
  try {
    ...
    if (ext.week_number === undefined || !ext.challenge_name || !ext.difficulty)
      throw Error("No Week or incomplete challenge data")
    add(ext.week_number, ext.challenge_name, ext.difficulty)
